...
class Position:
    ...
    def __init__(self, longitude_degrees, latitude_degrees):
        ...
        # assert : raise an exception if False
...
class Zone:
    ...
    # Class Attributes (constant if out the class) we write 
    # cls.WIDTH_DEGREES
    ...
    def _initialize_zones(cls):
        # Note that this method is "protected": we prefix the method name with "_".
        cls.ZONES = []
